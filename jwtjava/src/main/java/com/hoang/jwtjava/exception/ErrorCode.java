...
public enum ErrorCode {
    ...
    CHAT_AUTH_FAILED(1026, "Gemini API key is invalid or unauthorized", HttpStatus.BAD_GATEWAY),
    CHAT_QUOTA_EXCEEDED(1027, "Gemini API quota exceeded — check billing/free-tier limits", HttpStatus.TOO_MANY_REQUESTS),
